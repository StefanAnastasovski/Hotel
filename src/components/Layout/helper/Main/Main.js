            ...
            <div className="main-picture justify-content-end">
                ...
                <div className="container ">
                    <div className="position-absolute main-title text-color-title">
                        <h1 className="font-weight-bold">Welcome to <span className="new-line">Stefan Hotel</span></h1>
                    </div>
                </div>
            </div>
                ...
                <div className="row">
                    <div className="col-8 my-4">
                        ...
                        <p>
                            ...
                            At one of the most luxurious hotels in the heart of Miami, Florida, guests can experience:
